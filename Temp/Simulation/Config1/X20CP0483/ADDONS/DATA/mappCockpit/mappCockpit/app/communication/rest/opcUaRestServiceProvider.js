...
define(["require", "exports", "./restService", "../../common/mappCockpitConfig"], function (require, exports, restService_1, mappCockpitConfig_1) {
    ...
    let OpcUaRestServiceProvider = OpcUaRestServiceProvider_1 = class OpcUaRestServiceProvider {
        ...
        constructor() {
            ...
            // Specifies the datapoint names array base for reading trace data
            this.mappCockpitTraceDataPointNamesId = "s=NewTraceRecord.RecordedDataPointNames";
        ...
        getWsBaseUrl() {
            ...
            if (location.protocol == "https:") {
                return "wss://" + location.hostname + ":" + location.port + "/api/1.0/pushchannel";
            }
            return "ws://" + location.hostname + ":" + location.port + "/api/1.0/pushchannel";
        }
        /**
