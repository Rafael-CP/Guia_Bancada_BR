    ...
    let MappCockpitTraceDataReader = class MappCockpitTraceDataReader {
        ...
        requestReadTraceDataPointsFromTarget() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    var traceDataPointBaseNames = this._diagnosticProvider.namespace + ";" + opcUaRestServices_1.OpcUaRestServices.mappCockpitTraceDataPointNamesId;
                    traceDataPointNames = yield opcUaRestServices_1.OpcUaRestServices.readNodeAttribute(this._diagnosticProvider.sessionId, traceDataPointBaseNames);
                }
                catch (error) {
                }
