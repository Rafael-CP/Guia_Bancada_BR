...
define(["require", "exports", "../../../widgets/common/uniqueIdGenerator"], function (require, exports, uniqueIdGenerator_1) {
    "use strict";
    ...
    let OpenContentView = class OpenContentView {
        constructor(componentID, name, viewType, groupTags) {
            this._viewID = uniqueIdGenerator_1.UniqueIdGenerator.getInstance().getUniqueIdFromString(componentID + viewType.toString());
