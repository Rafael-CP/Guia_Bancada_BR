...
define(["require", "exports", "../../online/mappCockpitComponent", "../../../framework/command", "./traceDataReader", "./traceConfig/traceConfigData", "./traceConfig/traceConfigExport", "./traceConfig/traceConfigImport", "../../../framework/componentHub/bindings/bindings", "../../../framework/componentHub/bindings/bindingDeclarations"], function (require, exports, mappCockpitComponent_1, command_1, traceDataReader_1, traceConfigData_1, traceConfigExport_1, traceConfigImport_1, bindings_1, Binding) {
    "use strict";
    ...
    TraceMethodIds.ClearDataPoints = "ClearDataPoints";
    TraceMethodIds.SetStartTrigger = "SetStartTrigger";
    TraceMethodIds.ClearStartTriggers = "ClearStartTriggers";
    // obsolete (not needed in mappCockpit anymore)
    TraceMethodIds.RemoveDataPoint = "RemoveDataPoint";
    TraceMethodIds.RemoveStartTrigger = "RemoveStartTrigger";
    ...
    let TraceControl = class TraceControl {
        ...
        removeAllDatapoints() {
            return __awaiter(this, void 0, void 0, function* () {
                let clearDataPointsMethod = this.getTraceMethod(TraceMethodIds.ClearDataPoints);
                if (clearDataPointsMethod != undefined) {
                    yield this.executeMethod(clearDataPointsMethod);
                }
            });
        }
        /**
        ...
        removeAllStartTriggers() {
            return __awaiter(this, void 0, void 0, function* () {
                let clearStartTriggersMethod = this.getTraceMethod(TraceMethodIds.ClearStartTriggers);
                if (clearStartTriggersMethod != undefined) {
                    yield this.executeMethod(clearStartTriggersMethod);
                }
            });
        }
        /**
