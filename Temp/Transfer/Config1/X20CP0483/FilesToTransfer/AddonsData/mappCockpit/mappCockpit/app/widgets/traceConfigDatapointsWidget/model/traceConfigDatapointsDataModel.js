...
define(["require", "exports", "../../../models/dataModelBase", "../../../models/dataModelInterface"], function (require, exports, dataModelBase_1, dataModelInterface_1) {
    "use strict";
    var TraceConfigDatapointsDataModel_1;
     ...
     */
    let TraceConfigDatapointsDataModel = TraceConfigDatapointsDataModel_1 = class TraceConfigDatapointsDataModel extends dataModelBase_1.DataModelBase {
        /**
        ...
        /**
         * Adds a new datapoint at the given index if limit(maxDatapointCount) is not exceded or datapoint with same name is already in the list
         *
         * @param {number} index
        ...
        addDatapoint(index, datapoint) {
            if (this._data.length >= TraceConfigDatapointsDataModel_1.maxDatapointCount) {
                console.info("Only " + TraceConfigDatapointsDataModel_1.maxDatapointCount.toString() + " datapoints are supported!");
                return;
            }
    ...
    TraceConfigDatapointsDataModel.maxDatapointCount = 150;
    TraceConfigDatapointsDataModel = TraceConfigDatapointsDataModel_1 = __decorate([
        mco.role()
