        ...
        readAllTraceDataPoints() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                traceableComponents.forEach((traceableComponentcomponent) => {
                    let componentTracePoints = this.readComponentTraceDataPoints(traceableComponentcomponent);
                    allAvailableTraceDataPoints = allAvailableTraceDataPoints.concat(componentTracePoints);
                });
